...
public class ProdutoRequestDTO {
	...
	public Produto converterParaEntidade(Long codigoCategoria) {
		return new Produto(descricao, quantidade, precoCusto, preco_venda, observacao, new Categoria(codigoCategoria));
	}
	//Construtor para o atualizar que precisa do código do produto
	public Produto converterParaEntidade(Long codigoCategoria, Long codigoProduto) {
		return new Produto(codigoProduto, descricao, quantidade, precoCusto, preco_venda, observacao, new Categoria(codigoCategoria));
	}
