...
INSERT INTO produto (descricao, quantidade, preco_curto, preco_venda, observacao, codigo_categoria) values ('Fogão ElÃ©trico De Mesa', 8, 60.80, 106.80, 'Fogão Elétrico De Mesa 2 Pratos 2000 Watts Agrato 220v', 4);
INSERT INTO produto (descricao, quantidade, preco_curto, preco_venda, observacao, codigo_categoria) values ('Fogão 4 Bocas', 20, 280.50, 424.86, 'Fogão 4 Bocas Atlas Com Acendimento AutomÃ¡tico', 4);
INSERT INTO produto (descricao, quantidade, preco_curto, preco_venda, observacao, codigo_categoria) values ('Fogão 5 Bocas', 30, 864, 1164.94, 'FogÃ£o 5 Bocas Tripla Chama Automático Agile Glass Inox Atlas', 4);
